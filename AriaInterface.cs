...
namespace AutoSimRT
{
    public static class AriaInterface
    {
        ...
        public static void Connect()
        {
            ...
            connection = new SqlConnection("data source = SLTVARDB4; initial catalog = VARIAN; persist security info = True; user id = ; password = ; Connection Timeout=5; MultipleActiveResultSets = True");
